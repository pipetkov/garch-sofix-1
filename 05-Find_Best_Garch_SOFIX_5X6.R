...
dist_to_use <-c('norm', 'snorm', 'std', 'sstd', 'ged','sged') # see rugarch::ugarchspec help for more
...
x11()  ; p1 ; ggsave('figs/fig05_best_garch-5X6.png', limitsize = TRUE)
...
write_rds(my_best_garch, 'data/garch_model5X6.rds')
