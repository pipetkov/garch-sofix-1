...
distribution_to_estimate <-  c('norm', 'snorm', 'std', 'sstd', 'ged','sged') # distribution used in all models
my_html_file <- 'tabs/tab06_full-estimation_SOFIX-5X6.html' # where to save html file?
